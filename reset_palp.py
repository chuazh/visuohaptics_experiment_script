...
PSM_pos = ld4.load_manipulator_pose('./manipulator_homing/psm_home_palp.txt')
MTMR_pos = ld4.load_manipulator_pose('./manipulator_homing/mtm_home_palp.txt')
p2 = dvrk.psm('PSM2')
m2 = dvrk.mtm('MTMR')
c = dvrk.console()
